...
const bentoCategories = [
  ...
  },
  {
    ...
    description:
      'Supervised and unsupervised modeling, convolutional and recurrent architectures, segmentation and detection pipelines trained from scratch.',
    stat: '99.77% ACCURACY',
  ...
  },
  {
    ...
    badge: 'FOUNDATION',
    items: ['Python', 'C', 'SQL', 'FastAPI', 'REST APIs', 'JavaScript', 'Git', 'GitHub'],
    description:
